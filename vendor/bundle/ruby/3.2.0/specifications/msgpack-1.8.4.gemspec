...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/msgpack/msgpack-ruby/issues", "changelog_uri" => "https://github.com/msgpack/msgpack-ruby/blob/master/ChangeLog", "documentation_uri" => "https://github.com/msgpack/msgpack/blob/master/spec.md", "source_code_uri" => "https://github.com/msgpack/msgpack-ruby" } if s.respond_to? :metadata=
  ...
  s.homepage = "https://msgpack.org/".freeze
